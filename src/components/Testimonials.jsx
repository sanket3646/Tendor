...
export default function Testimonials() {
  ...
  const testimonials = [
    {
      name: "अजय सर",
      position: "सहायुक्त पोलीस आयुक्त विभाग दोन",
      content: "मा जिल्हाधिकारी कार्यालय येथे नामनिर्देश कालावधीत जेवणाची व्यवस्था अत्यंत उत्तम होती तसेच जेवण दर्जेदार आणि चविष्ट होते.",
      rating: 5,
    },
    {
      name: "मा सहाय्यक जिल्हा अधिकारी कार्यालय",
      position: "सोलापूर",
      content: "जिल्हाधिकारी कार्यालय येथे नामनिर्देश कालावधीत जेवणाची व पाण्याची उत्तम व्यवस्था करण्यात आलेली होती.",
      rating: 5,
    },
    {
      name: "सहाय्यक अधिकारी गाडेकर सर",
      position: "",
