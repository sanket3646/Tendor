...
export default function LoksabhaVehicleProject() {
  return (
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="animate-fade-in-up">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold gradient-text mb-8">
              Loksabha Elections – Vehicle Tender (2024)
            </h1>
          </div>
          ...
          <div className="neuro-card-dark p-4 mb-12 animate-scale-in animate-delay-300">
            <img
              src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68c03428f112e80b1a3b1ccc/8dfb28260_20240424175912_IMG_63521.jpg"
              alt="Vehicle services for Loksabha Elections"
            ...
            <div className="lg:col-span-2 space-y-8 animate-slide-in-left animate-delay-500">
              <div>
                ...
                <p className="text-gray-300 leading-relaxed text-lg mb-6">
                  Successfully completed vehicle services tender for the Solapur District during the General Elections Lok Sabha 2024. This comprehensive project involved providing reliable transportation solutions for Election Commission officers and workers across two major constituencies.
                </p>
                <p className="text-gray-300 leading-relaxed text-lg">
                  Our fleet included mobile campaigning vans and election surveillance vehicles, ensuring smooth operations throughout the election period. All vehicles were maintained to the highest standards with experienced drivers and proper documentation.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-3 text-gray-300">
                  <li className="flex items-start">
                    ...
                    Mobile campaigning vans for election activities
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-blue-400 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    Election surveillance vehicles for monitoring
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-blue-400 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    Transportation for Election Commission staff
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-blue-400 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    24/7 vehicle availability during election period
                  </li>
                </ul>
              </div>
            </div>
